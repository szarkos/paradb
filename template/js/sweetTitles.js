...
Modified by: Bram Gerritsen (http://www.dustindiaz.com/sweet-titles-finalized#comment-8339)
*/
var sweetTitles = {             
	xCord : 0,								// @Number: x pixel value of current cursor position
	yCord : 0,								// @Number: y pixel value of current cursor position
	tipElements : ['abbr'],	// @Array: Allowable elements that can have the toolTip
	...
	init : function() {
		...
		this.fading = 0; //Customize this setting
		this.delay = 500; //Customize this setting
	...
	tipOver : function(e) {
		...
		tID = window.setTimeout("sweetTitles.tipShow()", sweetTitles.delay);
	...
	tipShow : function() {		
		...
		var addy = '';
		var access = '';
		if ( anch.nodeName.toLowerCase() == 'a' || anch.nodeName.toLowerCase() == 'area' ) {
...
addEvent(window,'load',loadTooltip);
