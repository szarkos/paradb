<?php
 ...
 //
 // File: moonphase.inc.php
 //	  Based on the Perl module Astro::MoonPhase, version 0.52.
 //	  Translated to PHP by Stephen A. Zarkos <obsid@sentry.net>.
 //
 //	  Original Astro::MoonPhase module is distributed under the
 //	  public domain, and so is this.
 //
 //-------------------------------------------------------------------//
